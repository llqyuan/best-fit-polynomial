...
class UserInputOutput {
    private:
        ...
        void print_commands(void) {
            cout << "Commands: " 
                << commands :: add_cmd << ", "
                << commands :: remove_cmd << ", "
                << commands :: calculate_cmd << ", "
                << commands :: print_cmd << ", "
                << commands :: help_cmd << ", "
                << commands :: quit_cmd << "." << endl;
        }
        ...
        //   pointer)
        Matrix * least_squares_matrix(vector<posn *> * plist, 
                                      const int degree)
        {
    ...
    public:
        ...
        // best_fit_polynomial executes the program
        void best_fit_polynomial(void) {
                ...
                if (status) {
                    if (status == action_statuses :: adding_x) {
                        ...
                        if (!(sstream >> convert_to_float_temp)) {
                            ...
                            continue;
                        } else if (this->entry_exists(
                            &posn_list, convert_to_float_temp)) {
...
int main(void) 
{
    UserInputOutput().best_fit_polynomial();
}
